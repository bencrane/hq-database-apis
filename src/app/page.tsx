...
export default function Home() {
  const endpoints = [
    ...
    { method: "GET", path: "/api/views/people", description: "People with company firmographics (for ColdCmd)" },
    { method: "GET", path: "/api/views/companies", description: "Company firmographics (for ColdCmd)" },
    { method: "GET", path: "/api/salesnav-scrapes", description: "Raw Sales Navigator scrapes" },
    { method: "GET", path: "/api/salesnav-scrapes/export/csv", description: "Export scrapes as CSV batches" },
