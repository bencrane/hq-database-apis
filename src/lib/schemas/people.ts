...
export const PersonProfileSchema = z
  .object({
    ...
    certifications: z.array(z.record(z.string(), z.unknown())).nullable(),
    languages: z.array(z.record(z.string(), z.unknown())).nullable(),
    courses: z.array(z.record(z.string(), z.unknown())).nullable(),
    patents: z.array(z.record(z.string(), z.unknown())).nullable(),
    projects: z.array(z.record(z.string(), z.unknown())).nullable(),
    publications: z.array(z.record(z.string(), z.unknown())).nullable(),
    volunteering: z.array(z.record(z.string(), z.unknown())).nullable(),
    awards: z.array(z.record(z.string(), z.unknown())).nullable(),
