...
export const CompanyFirmographicsSchema = z
  .object({
    ...
    primary_location: z.record(z.string(), z.unknown()).nullable(),
    all_locations: z.record(z.string(), z.unknown()).nullable(),
...
export const CompanyDiscoverySchema = z
  .object({
    ...
    industry: z.string().nullable().openapi({ example: "Technology" }),
    industries: z.record(z.string(), z.unknown()).nullable(),
    description: z.string().nullable(),
    ...
    resolved_domain: z.record(z.string(), z.unknown()).nullable(),
    derived_datapoints: z.record(z.string(), z.unknown()).nullable(),
    source_last_refresh: TimestampSchema.nullable(),
    created_at: TimestampSchema.nullable(),
